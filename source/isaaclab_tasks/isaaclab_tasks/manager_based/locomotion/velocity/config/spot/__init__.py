...
gym.register(
    id="Isaac-Velocity-Long-Corridor-Spot-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.spot_long_corridor_env_cfg:SpotLongCorridorEnvCfg",
    },
)

gym.register(
    id="Isaac-Velocity-Long-Corridor-Spot-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.spot_long_corridor_env_cfg:SpotLongCorridorEnvCfg_PLAY",
    },
)
